...
input = os.listdir('D:\\python_workspace\\kdd-hw\\linerlog\\Daily beta\\')
...
for data_name in input:  
    if(data_name in processed_csv):
        continue
    data = pd.read_csv('D:\\python_workspace\\kdd-hw\\linerlog\\Daily beta\\'+data_name)
    ...
    data_after_produce.to_csv('D:\\python_workspace\\kdd-hw\\linerlog\\processed_Daily beta\\'+data_name,index=False)
